...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $sql = "INSERT INTO `countries` (`id`, `nome`, `nome_pt`, `sigla`, `bacen`) VALUES
        ...
        $sql = "INSERT INTO `cities` (`id`, `nome`, `uf`, `ibge`) VALUES
        ...
        INSERT INTO `cities` (`id`, `nome`, `uf`, `ibge`) VALUES
        ...
        $sql = "INSERT INTO `ufs` (`id`, `nome`, `uf`, `ibge`, `pais`, `ddd`) VALUES
        (1, 'Acre', 'AC', 12, 1, '68'),
